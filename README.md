...
* [XFINLAB](https://www.xfinlab.com/intelligence-api.html) - Financial intelligence API with market events, sentiment, technical analysis, and macro data, plus an MCP server for AI agents.
