...
* [Market Brief](https://github.com/beepboop2025/market-brief) - MIT-licensed browser and Python tools for source-linked funding, capital-market, and liquidity briefs with local snapshot comparisons ([browser app](https://beepboop2025.github.io/market-brief/), [v0.1.0 release](https://github.com/beepboop2025/market-brief/releases/tag/v0.1.0)).
